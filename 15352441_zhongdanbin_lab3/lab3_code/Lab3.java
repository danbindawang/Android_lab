...
public class Lab3 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //创建一个LinearLayoutManager对象，将其设置到RecyclerView中
		LinearLayoutManager layoutManager = new LinearLayoutManager(this);
        recyclerView.setLayoutManager(layoutManager);
		//创建Good_recyclerAdapter实例，将商品列表传入
        ...
        listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                mbuilder.setTitle("移除商品")
						...
						//点击确定按钮，将购物车列表相应商品移出，并刷新listadapter
                        ...
                        .show();
				//注意，为了使长按事件和点击事件不冲突，返回值为true
                return true;
            }

        });

		//通过悬浮按钮的tag值判断显示商品列表还是购物车列表
